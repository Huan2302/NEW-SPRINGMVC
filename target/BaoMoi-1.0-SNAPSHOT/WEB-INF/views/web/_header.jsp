                    ...
                    <div class="admin__header bg-light">
                        <nav class="navbar navbar-expand-md navbar-light bg-light px-4">
                            <a class="navbar-brand mr-5" href="#1">
                                <img src="<c:url value='/template/web/img/logo.png'/>" alt="logo" class="img img-fluid" width="100px">
                            </a>
            ...
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link text-white" href="${pageContext.request.contextPath}/tin-nong">Tin nóng</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-white" href="${pageContext.request.contextPath}/tin-moi">Tin mới trong ngày</a>
                        </li>
